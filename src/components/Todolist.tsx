...
export const Todolist: React.FC<PropsType> =({children, ...props}) =>{
    ...
    const setOnchangeInputRefValueToNull = () => {
        if(onchangeInputRef.current) {
            onchangeInputRef.current.value =""
        }
    }
    const addTask = () => {
        onchangeInputRef.current &&
        props.addTask(onchangeInputRef.current.value);
        setOnchangeInputRefValueToNull()
        // setTitle("");
    }
    ...
    return <div>
        ...
        <div>
            <input
                // value={onchangeInputRef.current.value}
